 ...
 * @Description: delete one or more docFile-records
 */
...
class DeleteDoc extends Crud {
    ...
    async deleteDoc(): Promise<ResponseMessage> {
...
function newDeleteDoc(params: CrudTaskType,
                         options: CrudOptionsType = {}) {
    return new DeleteDoc(params, options);
}

export { DeleteDoc, newDeleteDoc };
