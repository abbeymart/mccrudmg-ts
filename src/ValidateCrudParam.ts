...
export function validateDeleteParams(crudParams: CrudTaskType) {
    // Initialise error object and patterns matching:
    let errors: any = {};
    ...
    try {
        ...
        if ((!crudParams.docIds || crudParams.docIds.length < 1) && (!crudParams.queryParams || Object.keys(crudParams.queryParams).length < 1)) {
...
export function validateGetParams(crudParams: CrudTaskType) {
    // Initialise error object and patterns matching:
    let errors: any = {};
...
export function validateLoadParams(crudParams: CrudTaskType) {
    // Initialise error object and patterns matching:
    let errors: any = {};
