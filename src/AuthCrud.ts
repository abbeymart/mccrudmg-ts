 ...
 * @Description: mc-central-ts: crud operations authorization
 */
...
export class AuthCrud extends Crud {
    ...
    async authGet(by = "id"): Promise<ResponseMessage> {
        ...
        if (by.toLowerCase() !== "id") {
            ...
            return await this.taskPermission(TaskTypes.READ);
        }
    ...
    async authCreate(by = "id"): Promise<ResponseMessage> {
        ...
        if (by.toLowerCase() !== "id") {
            ...
            return await this.taskPermission(TaskTypes.CREATE);
        }
    }
    ...
    async authUpdate(by = "id"): Promise<ResponseMessage> {
        ...
        if (by.toLowerCase() !== "id") {
            ...
            return await this.taskPermission(TaskTypes.UPDATE);
        }
    ...
    async authDelete(by = "id"): Promise<ResponseMessage> {
        ...
        if (by.toLowerCase() !== "id") {
            ...
            return await this.taskPermission(TaskTypes.DELETE);
        }
    }
}

// factory function
export function newAuthCrud(params: CrudTaskType, options: CrudOptionsType = {}) {
